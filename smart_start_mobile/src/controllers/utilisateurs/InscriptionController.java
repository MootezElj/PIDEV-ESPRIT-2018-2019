...
public class InscriptionController implements Initializable {
    ...
    public void handleBtnSkip(MouseEvent event){
        ...
        if (user.getRoleJv().equals("Freelancer")) loadPage(event, "/views/DashboardFreelancer.fxml");
        else loadPage(event, "/views/utilisateurs/DashboardClient.fxml");
    }
