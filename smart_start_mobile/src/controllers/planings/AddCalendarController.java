...
public class AddCalendarController implements Initializable {
    ...
    void generateNewCalendar(MouseEvent event) {
            ...
            else
            {
               // Set the starting and ending years, and the starting date, and store them in a Model object
                ...
                String calendarQuery = "INSERT INTO CALENDARS VALUES ("
                        + "'" + calName2 + "', " + startingYear + ", " + endingYear + ", " + "'" + startingDate +  "',"  + "'" + currentUser.getId() + "')";
                ...
                if(databaseHandler.executeAction(calendarQuery)) 
                {
                   Alert alertMessage = new Alert(Alert.AlertType.INFORMATION);
                    alertMessage.setHeaderText(null);
                    alertMessage.setContentText("Calendar creer avec succès");
                    alertMessage.showAndWait();
                ...
                else //if there is an error
                {
                    ...
                    alertMessage.setHeaderText(null);
                    alertMessage.setContentText("Impossible de creer Calndrier!\n utiliser un nouveau nom pour la calendrier");
                    alertMessage.showAndWait();
                }
        ...
        {
            Alert alert = new Alert(AlertType.WARNING, "Completer tous les champs.");
            alert.showAndWait();
        }        
    }
