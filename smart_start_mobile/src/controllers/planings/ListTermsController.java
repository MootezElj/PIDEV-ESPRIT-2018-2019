...
public class ListTermsController implements Initializable {
    ...
    private void editTermEvent() {
        ...
        if (!tableView.getSelectionModel().isEmpty()){
            ...
            try {
               ...
               editTermLoader.setLocation(getClass().getResource("/views/planings/edit_term.fxml"));
    ...
    private void editTerm(MouseEvent event) {
     ...
     @FXML
    private void addTerm(MouseEvent event) {
         System.out.println("controller.ListTermsController.addTerm()");
        addTermEvent();
    }
    ...
    public void addTermEvent (){
        System.out.println("controller.ListTermsController.addTermEvent()");
            ...
            try {
               // Load root layout from fxml file.
               FXMLLoader addTermLoader = new FXMLLoader();
               addTermLoader.setLocation(getClass().getResource("/views/planings/add_term.fxml"));
               AnchorPane rootLayout = (AnchorPane) addTermLoader.load();
               Stage stage = new Stage(StageStyle.UNDECORATED);
               stage.initModality(Modality.APPLICATION_MODAL); 

               AddTermContoller termController = addTermLoader.getController();
               termController.setListController(this);
