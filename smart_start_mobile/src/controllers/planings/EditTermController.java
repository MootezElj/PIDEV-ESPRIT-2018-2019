...
//        termLabel.setText(name);
    ...
    public void updateTermDate() {
        ...
        String currenttermName = Model.getInstance().term_name;
        String currentTermDate = Model.getInstance().term_date;
        
        //Get the ID of the term to be updated
        int termID = databaseHandler.getTermID(currenttermName);
        ...
        if(termDatePicker.getValue() == null || termName.getText()== null){
            Alert alertMessage = new Alert(Alert.AlertType.ERROR);
            alertMessage.setHeaderText(null);
            alertMessage.setContentText("completer tous les champs");
        ...
        String newName = termName.getText();
        ...
        if(newTermStartingDate.equals(currentTermDate) && newName.equals(currenttermName)) {
            Alert alertMessage = new Alert(Alert.AlertType.INFORMATION);
            alertMessage.setHeaderText(null);
            alertMessage.setContentText("vous n'avez rien changer");
            alertMessage.showAndWait();
            return;
        }
