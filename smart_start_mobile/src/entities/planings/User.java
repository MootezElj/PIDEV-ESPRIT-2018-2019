...
public class User {
    ...
    ***/
    ...
    public User(int id, String username, String usernameCanonical, String email, String emailCanonical, String password, String roleJv, String firstName,String competance, String lastName) {
        this.id = id;
        this.username = username;
        this.usernameCanonical = usernameCanonical;
        this.email = email;
