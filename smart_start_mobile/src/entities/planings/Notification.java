...
public final class Notification {
     ...
     */
    public Notification(String title, String body, Image img, Paint rectangleFill) {
     ...
     */
    public Notification(String title, String body, NotificationType notificationType ) {
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/icons/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getResource("/icons/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getResource("/icons/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/icons/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/icons/error.png");
                paintHex = "#CC0033";
                break;
