 ...
 * @author X
 */
public class ChartFXMain extends Application {

	@Override
	public void start(Stage primaryStage) throws IOException{
//		ProjetDao projetDao = new ProjetDao();
//		Projet p = projetDao.selectAll().get(0);
//		User fr= new User(19);
//		User c = new User(2);
//		Date today = Calendar.getInstance().getTime();
//		Demande d = new Demande(1, p, fr, "dem2", "dec1", 12.0, 24.0, 100.0, today, true, false);
//		DemandeDao demandeDao = new DemandeDao();
//		demandeDao.update(d);
//		Parent root = FXMLLoader.load(getClass().getResource("listeProjet.fxml"));
		Parent root = FXMLLoader.load(getClass().getResource("/views/offres/user/Authentification.fxml"));
//		Parent root = FXMLLoader.load(getClass().getResource("/views/offres/demande/home.fxml"));
...
//
//        TableColumn<Person, String> firstNameCol = new TableColumn("Nom");
...
//                });
//
//        TableColumn<Person, Date> emailCol = new TableColumn("Date");
